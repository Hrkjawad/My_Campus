                  ...
                  builder: (facShowGroupBatchSectionCourseController) {
                    return GestureDetector(
                      onTap: () async {
                        ...
                        final result = await facShowGroupBatchSectionCourseController.showGroups();
                        if (result) {
                          final dataList = facShowGroupBatchSectionCourseController.facultyCreatingSubGrpBatchSecDataList;
                                            ...
                                            child: ListView.separated(
                                              ...
                                              itemBuilder: (context, index) {
                                                return InkWell(
                                                  ...
                                                  child: ListTile(
                                                    leading: Text(
                                                      batchCoursePairs[index]['batch'] ?? 'Unknown',
                                                      style: TextStyle(
                                                    ...
                                                    title: Text(
                                                      batchCoursePairs[index]['courseCode'] ?? 'Unknown',
                                                      style: TextStyle(
                                                        color: const Color(0xFF0D6858),
                                                        fontWeight: FontWeight.w500,
                                                        fontSize: 20.sp,
