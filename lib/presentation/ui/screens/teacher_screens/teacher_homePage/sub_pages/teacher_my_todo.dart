...
import 'package:my_campus/presentation/ui/widgets/customised_titles_method.dart';
...
class _FacMyTodoState extends State<FacMyTodo> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              meetingTitleAndDateMethod(context),
            ],
          ),
        ),
      ),
  ...
  Expanded meetingTitleAndDateMethod(BuildContext context) {
    return Expanded(
      child: Padding(
