...
class SubjectListAdd extends StatefulWidget {
  const SubjectListAdd({super.key});

  @override
  State<SubjectListAdd> createState() => _SubjectListAddState();
}

class _SubjectListAddState extends State<SubjectListAdd> {
